...
import { e as getStaticPathsBlogList, h as blogListRobots } from './blog_B48-P7uP.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "C:/Users/haloG/Desktop/Astro/shining-shell/src/pages/[...blog]/[...page].astro", void 0);

const $$file = "C:/Users/haloG/Desktop/Astro/shining-shell/src/pages/[...blog]/[...page].astro";
const $$url = "/[...blog]/[...page]";
